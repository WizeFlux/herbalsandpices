<script lang="ts">
  /**
   * Decorative plate frame — used in Hero thumbnail strip.
   * SVG source lives in src/icons/plate-frame.svg (used by astro-icon).
   * This Svelte wrapper mirrors it for use in Svelte components.
   */
  interface Props {
    class?: string;
  }
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 161 92" fill="none" class={className}>
  <path
